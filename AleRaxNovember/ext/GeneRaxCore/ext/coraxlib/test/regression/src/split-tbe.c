...
void test_tbe()
{
  const char *ref_tree = "(Woolly:0.02000173,Spider:0.01195957,(Howler:0.03921588,"
  ...
  const char *boot1_tree = "((Squirrel:0.04749782,((Saki:0.02577556,Titi:0.02534069):0.01417705,"
  ...
  const char *boot2_tree = "((Baboon:0.100000,(Colobus:0.100000,(Gibbon:0.100000,"
