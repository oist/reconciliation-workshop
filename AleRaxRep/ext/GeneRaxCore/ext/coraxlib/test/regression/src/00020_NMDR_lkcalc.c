...
int main(int argc, char *argv[])
{
  ...
  corax_set_tip_states(partition, 0, corax_map_nt, "WAC-CTA-ATCT");
  corax_set_tip_states(partition, 1, corax_map_nt, "CCC-TTA-ATGT");
  corax_set_tip_states(partition, 2, corax_map_nt, "A-C-TAG-CTCT");
  corax_set_tip_states(partition, 3, corax_map_nt, "CTCTTAA-A-CG");
  corax_set_tip_states(partition, 4, corax_map_nt, "CAC-TCA-A-TG");
