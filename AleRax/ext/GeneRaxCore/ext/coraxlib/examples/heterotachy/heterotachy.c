                             ...
                             double *         branch_lengths)
{
  ...
  {
    for (j = 0; j < 4; ++j) params_indices[j] = i;
...
int main(int argc, char *argv[])
{
  ...
  double frequencies[3][4] = {{0.17, 0.19, 0.25, 0.39},
                              {0.17, 0.19, 0.25, 0.39},
                              {0.17, 0.19, 0.25, 0.39}};
  ...
  double subst_params[3][6] = {
      {1, 1, 1, 1, 1, 1}, {1, 2, 1, 1, 2, 1}, {.5, 2, 1, .5, 2, 1}};
  ...
  update_pmatrices(
      partition, matrix_indices, matrix_start, matrix_count, branch_lengths);
  ...
  pll_update_clvs(partition, operations, 2);
  logl = pll_compute_edge_loglikelihood(
      partition, 4, 0, 5, 1, 4, freqs_indices, NULL);
